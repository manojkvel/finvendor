jQuery(document).ready(function() {
	...
	var getEquityListHtml = function(response) {
		...
		for(var i = 0; i < len; i++) {
			...
			"<td>" + 
			"<div class='company' data-code='" + response.equity[i].isinCode + "' data-toggle='tooltip' title='See all reports for " + response.equity[i].company + "'>" + response.equity[i].company + "</div>" + 
