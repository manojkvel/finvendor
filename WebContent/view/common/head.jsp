...
<link rel="stylesheet" href="<%=request.getContextPath() %>/resources/css/style.css" rel="stylesheet" />
...
<link rel="stylesheet" href="<%=request.getContextPath() %>/resources/css/style-metro.css"type="text/css"/>
<link rel="stylesheet" href="<%=request.getContextPath() %>/resources/css/style-II.css" type="text/css"/>
<link rel="stylesheet" href="<%=request.getContextPath() %>/resources/datepick/jsDatePick_ltr.min.css" type="text/css"/>
