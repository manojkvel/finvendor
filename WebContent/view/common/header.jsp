                                                        ...
                                                        <div class="nav-srch">
                                                            <div class="nav-srch-cnt ">
                                                                ...
                                                                <ul class="sf-menu hidden-xs" id="example">
                                                                    <li>
                                                                        <a href="${pageContext.request.contextPath}/view/common/inner.jsp?nav=SOLUTIONS">Research Reports</a>
                                                                        <ul>
                                                                            <li>
                                                                                <a href="${pageContext.request.contextPath}/view/common/inner.jsp?nav=SOLUTIONS&subNav=frrpd&RaYUnA=${finVen:encrypt(username)}">
                                                                    ...
                                                                    <li>
                                                                        <a href="${pageContext.request.contextPath}/view/common/inner.jsp?nav=SOLUTIONS">Brokers/Analysts</a>
                                                                    </li>
