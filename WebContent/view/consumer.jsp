							...
							<div class="portlet-body form">
								...
								<%-- 				<div><br/></div>
												...
												<div class="ColumnCommon"> 
													<label class="control-label-fileupload">File Upload (excel or csv)<span class="required">*</span></label>
													<div class="controlsfileupload">
														 <input type="text" id="orgname" value="C:\ConsumerUpload\preference_FV.CSV" class="m-wrap largefileuploadreadonly" readonly="readonly"  /> 
													</div>
													<div class="controlsfileuploadreadonly">
														 <input type="file" id="consumermyvendorfileUpload" placeholder="Company Logo" name="fileUpload" class="m-wrap largefileupload" style="margin: -47px 0px 3px 503px;"/>
													</div>
												</div>
												<div class="ColumnCommonray">
												<a class="consumermyvendorfileupload"> <span class="lable_header_add">Upload</span></a>
												</div>
												</div>
												<div><br/> </div>
												 <div class="Row">
													<div class="ColumnCommonvendorconsumer">
													<div class="control-group">
														<label class="control-label">Asset Class<span class="required">*</span></label>
														<div class="controls">
															<select name="consumerdatadeliveryassetclass" onchange="loadConsumerDataDeliverySecurityTypes(this.value);" id="consumerdatadeliveryassetclass">
															     <option value ="-SELECT-"> -SELECT- </option>
															     <c:forEach var="assetClasses" items="${assetClasses}">
															    	<option value="${assetClasses.asset_class_id}">${assetClasses.description}</option>
															 	 </c:forEach>
													...
													<div class="control-group">
														<label class="control-label">Security type<span class="required">*</span></label>
														<div class="controls">
															<select name="securitytype"  id="assetClassConsumerDataDeliverySecurityMaps" multiple="multiple">
															  	 <option value ="-SELECT-"> -SELECT- </option>
															     <c:forEach var="assetClassConsumerDataDeliverySecurityMaps" items="${assetClassConsumerDataDeliverySecurityMaps}">
																    <option value="${assetClassConsumerDataDeliverySecurityMaps.securityType.security_type_id}">${assetClassConsumerDataDeliverySecurityMaps.securityType.name}</option>
																  </c:forEach>
															 </select>
														</div>
													</div>
													...
													<div class="control-group">
														...
														<div class="controls">
															<select name="consumerdeliverymethod" multiple="multiple" id="consumerdeliverymethod">
													...
													<div class="control-group">
														...
														<div class="controls">
															<select name="consumerfeedtype" multiple="multiple" id="consumerfeedtype">
														      <option selected="selected" value ="-SELECT-" > -SELECT- </option>
														     <option value="Datafeed">Datafeed</option>
														     <option value="Web">Web</option>
														     <option value="FTP">FTP</option>
													 ...
													 <div class="ColumnCommonvendorpreconsumer">
													<div class="control-group">
														<label class="control-label">Data Cost Range<span class="required">*</span></label>
														<div class="controls">
															<select name="consumeracquisitioncostrange" multiple="multiple" id="consumeracquisitioncostrange">
															      <option selected="selected" value ="-SELECT-" > -SELECT- </option>
																 <c:forEach var="costs" items="${costs}">
																     <option value="${costs.cost_id}">${costs.range}</option>
																 </c:forEach>
													...
													<div class="control-group">
														<label class="control-label">Awards<span class="required">*</span></label>
														<div class="controls">
															<select name="awards" multiple="multiple" id="consumerawards">
															     <option selected="selected" value ="-SELECT-" > -SELECT- </option>
																 <c:forEach var="awards" items="${awards}">
												...
												<div class="control-group">
														<div class="controls">
														<div class="se" style="  margin: 0px 0px 0px 232px;">
													 	  <a class="consumermyvendorpreferenceaddtotable"> <span class="lable_header_add">Add More </span></a> 
													 	</div>
														</div>
													</div> 
												<div class="portlet-body">
												
												<table class="table table-striped table-bordered table-hover table-full-width" id="myvendorpreferencesample_1">
													<thead style="background-color:#7BCCA5;">
														<tr>
															<th>Vendor Type</th>
															<th>Vendor Region Of Incorp</th>
															<th>Vendor Country of Incorp</th>
															<th>Vendor Year of Operation</th>
											                <th>Support Coverage Region</th>
															<th>Support Coverage Time</th>
															<th>Support Coverage Time</th>
															<th>Actions</th>
														</tr>
													</thead>
												...
												<input type="hidden" id="consumermyvendorpreferencejsontable1" name="consumermyvendorpreferencejsontable1"/>
											</div>
