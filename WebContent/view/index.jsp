...
<title>FinVendor - Market Place for Financial Research Report Providers, Market Data Vendors and Trading Platform.</title>
	...
	<meta name="description" content="Search Free and Quality Equity Research Reports, Market Data Providers, Trading Platforms">
  <meta name="keywords" content="Finvendor, Free Equity Research Reports, Market Data Providers, Trading Platforms, Analytics Report">
  
  <meta property="og:title" content="FinVendor - Search Free and Quality Equity Research Reports, Market Data Providers, Trading Platforms" />
  <meta property="og:type" content='website' />
  <meta property="og:url" content="https://www.finvendor.com" />
  <meta property="og:description" content="Search Free and Quality Equity Research Reports, Market Data Providers, Trading Platforms"/>
  <meta property="og:image" content="../resources/images/company-logo-header.jpg"/>
  <meta property="og:site_name" content="JioCloud" />
  <meta property="fb:app_id" content="" />

  <meta name="twitter:url" content="https://www.finvendor.com" />
  <meta name="twitter:title" content="FinVendor - Search Free and Quality Equity Research Reports, Market Data Providers, Trading Platforms" />
  <meta name="twitter:image" content="../resources/images/company-logo-header.jpg" />
  <meta name="twitter:description" content="Search Free and Quality Equity Research Reports, Market Data Providers, Trading Platforms" />
...
End-User's RFP</span></div>
		...
		<section id="what_we_do">
			<div class="container">
				...
				<ul>
					<li><strong>Search the company:</strong> <br />Find the stock worthy of investment of your hard-earned money.</li>
					<li><strong>Free Access:</strong> <br />Get a free access to more than 1000 high quality broker research reports covered for Indian Stock Market.</li>
					<li><strong>Premium access:</strong> <br />Subscribe to a premium research reports provided by some trusted brokers/analysts.</li>
		...
		<section id="feature_list">
			<div class="feature_list">
				<h2>Our Solutions</h2>
				<ul>
					<li class="col-xs-12 col-sm-3 col-md-3 col-lg-3" style="visibility: hidden;">
					...
					<li class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
						<div class="counter-block">
							...
							<div class="feature_list_tooltip">
								...
								<span><a href="/view/common/inner.jsp?nav=SOLUTIONS&subNav=mdvad&RaYUnA=">See More</a></span>
							</div>							
						</div>
					</li>
					<li class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
						<div class="counter-block">
							...
							<span><a href="/view/common/inner.jsp?nav=SOLUTIONS&subNav=tavd&RaYUnA=">See More</a></span>
							</div>							
						</div>
					</li>
					<li class="col-xs-12 col-sm-3 col-md-3 col-lg-3" style="visibility: hidden;">
		...
		<section id="faq_list">
			<div class="container">
				<h2>FAQs section</h2>
				<ul>
					<li><strong>I don't see the research report for a specific Company or specific Broker. What to do?</strong> <br />Shoot us an email with all details at <a href="mailto: enquiry@finvendor.com">enquiry@finvendor.com</a></li>

					<li><strong>How can I publish the reports on FinVendor?</strong> <br />Shoot us an email with all details at <a href="mailto: sales@finvendor.com">sales@finvendor.com</a></li>

					<li><strong>I am finding some difficulty in using the Research report search page.</strong> <br />Take the screen shot and shoot us an email with all details at <a href="mailto: enquiry@finvendor.com">enquiry@finvendor.com</a></li>

					<li><strong>Do you support entitlement? Our report should be accessible to only selected group of
clients?</strong> <br />Yes, we do. It is customizable to individual broker/publisher level.</li>

					<li><strong>We need more paying clients, can you help with increasing our sales?</strong> <br />Yes, we can help you increase your sales. We can also provide you valuation leads.</li>
				</ul>
			</div>
		</section>
		...
		<section id="user_interest_info">
			<div class="container">
					...
					<div class="slider2">
						...
						<div class="slide">
							...
							<p>Information on case studies conducted on various topics relevant to our industry aimed to provide insights
								to our customers for them to identify similar circumstances and adopt the implementation if applicable.
							</p>
				...
				<div class="col-xs-12 col-sm-5 fv_signup_newsletter">
					...
					<p>Want to keep upto date with all our latest news and information? <br />Enter your email below to be added to our mailing list.</p>
					<form name="form_signup_newsletter">
						<ul>
							<li>
								<input type="email" name="signup_newsletter" placeholder="Email Address" />
							</li>
							<li>
								<a class="submit_btn">Signup</a>
							</li>
						</ul>
					</form>
				</div>
