...
public interface AdminDao {
	...
	public int updateReferenceDataRow(String sqlQuery) throws ApplicationException;
	public int deleteReferenceDataRow(String sqlQuery) throws ApplicationException;
}
