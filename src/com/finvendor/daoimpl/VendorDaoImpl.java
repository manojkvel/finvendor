...
public class VendorDaoImpl implements VendorDao{
	...
	*/
	...
	private final static String MARKET_DATA_VENDOR_OFFERINGS = "select asset.description ASSET_CLASS, off.name OFFERING_NAME, off.description OFFERING_DESCRIPTION, cov.region_ids REGION, cov.country_ids COUTRIES, off.LaunchedYear YEAR from vendor_offering off, vendor_datacoverage cov, asset_class asset where off.vendor_offering_id = cov.vendor_offering_id and asset.asset_class_id = off.asset_class_id and off.vendor_id = cov.vendor_id and off.vendor_id = :vendorId order by ASSET_CLASS, OFFERING_NAME";
