package com.finvendor.server.homepagesearch.rsrcharea.stock.dao;

import java.util.Map;

public interface IStockHomePageSearchDao {
	 ...
	 */
	String getSearchHint(Map<Object, Object> paramMap) throws RuntimeException;
}
