...
public interface IWebCompanyPriceAlert {
	...
	@ResponseBody
	ResponseEntity<?> updateCompanyPriceAlert(CompanyPriceAlertPojo companyPriceAlertPojo) throws WebApiException;
	...
	@ResponseBody
	ResponseEntity<?> deleteCompanyPriceAlert(List<CompanyPriceAlertPojo> pojoList) throws WebApiException;
