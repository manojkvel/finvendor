...
public class ReferenceDataDao {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ReferenceDataDao.class.getName());
    ...
    public List<AnalyticalSolutionSubType> getAnalyticalSolutionSubTypeForAnalyticsApplicationVendorOfferingByAnalyticalSolutionTypeId(
            ...
            throws ApplicationException {
        logger.debug(
                "Entering : ReferenceDataDaoImpl - getAnalyticalSolutionSubTypeForAnalyticsApplicationVendorOfferingByAnalyticalSolutionTypeId for : {}",
        ...
        logger.debug(
                "Leaving : ReferenceDataDaoImpl - getAnalyticalSolutionSubTypeForAnalyticsApplicationVendorOfferingByAnalyticalSolutionTypeId for : {}",
                analyticalSolutionTypeId);
