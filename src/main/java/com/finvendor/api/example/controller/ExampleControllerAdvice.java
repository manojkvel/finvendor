...
//
//import com.finvendor.api.exception.ApiException;
...
//import static com.finvendor.common.exception.ExceptionEnum.GENERAL_ERROR;
//
///**
// * @author  ayush
// */
...
//    public ResponseEntity<?> handlePersonNotFound(ApiException e) {
//        ErrorUtil.logError("ExampleController Error :", e);
//        return ErrorUtil.getError(GENERAL_ERROR.getCode(), GENERAL_ERROR.getUserMessage(), e);
//    }
//}
