...
import com.finvendor.api.metrics.dto.EquityResearchAnalyticsDto;
...
public class ConsumerAnalyticsDao {
    ...
    public String getRecordStats(String type, String subType, String perPageMaxRecords, String breachFlag) throws RuntimeException {
        ...
        try {
            ...
            if (actualTotalRecords != 0L) {
                ...
                long lastPageNumber = CommonCodeUtils.calculatePaginationLastPage(perPageMaxRecords, actualTotalRecords);
                statsJson = CommonCodeUtils.getRecordStatsJson(actualTotalRecords, lastPageNumber);
            } else {
                statsJson = "0";
            }
        } catch (Exception e) {
    ...
    public String getConsumerAnalytics(String type, String subType, String pageNumber, String perPageMaxRecords, String breachFlag) throws RuntimeException {
        String mainQuery = applyFilter(subType, breachFlag);
        String mainQueryWithPagintion = mainQuery + CommonCodeUtils.applyPagination(pageNumber, perPageMaxRecords);
