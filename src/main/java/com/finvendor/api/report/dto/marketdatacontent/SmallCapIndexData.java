...
public class SmallCapIndexData extends MarketIndexData {
    public SmallCapIndexData(String userName, String currentDate, String nifty50Index, String consecutiveNumber, String upDown,
