...
public interface IReseaechReportTableDao {
    Map<String, ? extends AbsResearchReportResult> findResearchReportTableData(String query, ResearchReportFilter filter, String offset, String perPageMaxRecords,
                                                                               String sortBy, String orderBy) throws RuntimeException;
}
