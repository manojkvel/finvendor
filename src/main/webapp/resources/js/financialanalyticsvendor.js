 ...
 */
 $(document).ready(function() {
	...
	+ "</li>"
	+ "<li>"
	+ "<input type='checkbox' name='asdCustomizableCalculationModels' id='asdCustomizableCalculationModels' />"
	+ "<label class='default_checkbox'>Customizable Calculation Models(?)</label>"
	+ "</li>"
	+ "<li>"
	+ "<input type='checkbox' name='asdRealtimeMarketData' id='asdRealtimeMarketData'  />"
