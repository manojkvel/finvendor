        ...
        function validateContactEmail(email){
        	var re = /^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
        	  if(re.test(email)){
        	    ...
        	    document.getElementById('contact_us_email').style.background ='#e35152';
        ...
        function validateContactNumber(phone){
        	...
        	if(regex.test(phone)){
        	    ...
        	    document.getElementById('contact_us_phone').style.background ='#e35152';
        ...
        function validateContactName(name){
        	...
        	if (name != "") {
        	    ...
        	    document.getElementById('contact_us_name').style.background ='#e35152';
