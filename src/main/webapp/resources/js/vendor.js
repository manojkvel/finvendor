jQuery(document).ready(function() {
	...
	$("#research_application .research_report_for_info h3").on("click", function() {
		$("#research_application .research_report_for_info .detail_container").slideToggle();
		$("#research_application .research_report_for_info h3 span").toggleClass("fa-chevron-up");
		$("#research_application .research_report_for_info h3 span").toggleClass("fa-chevron-down");
	});
	...
	addResearchReportsOffering = function(id) {
		...
		var vo_price_at_recomm = null;
		if($('#vo_price_at_recomm').is(':visible')) {
			vo_price_at_recomm = $('#research_application #vo_price_at_recomm').val();
		}
		...
		if(vo_price_at_recomm != '') {
			$("#research_application #vo_price_at_recomm").removeClass("error_field");
		} else {
		...
		*/
		...
		if( productName != '' && productDescription != '' && launchedYear != '' &&
			...
			var data = {
				...
				'vo_price_at_recomm' : vo_price_at_recomm,
...
function onEditVendorProfile() {
	getAnalystTypeList().then(function(response) {
		var analystTypeList = JSON.parse(response).analystType;
		var len = analystTypeList.length;
		var htmlCode = '';
		var rowHtml = 	"";
		...
		var $option='';
		for (var val in analystTypeList) {
			$option += "<option value='" + analystTypeList[val] + "'>" + analystTypeList[val] + "</option>";
		}
		$("select#personal_analyst_type").empty();
		$("select[name=personal_analyst_type]").append($option);	
		$("select[name=personal_analyst_type]").selectpicker('refresh');
	}, function(error) {
