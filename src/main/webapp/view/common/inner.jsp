...
<div class="inner-left-wrap" id="SOLUTIONS_mdvad">
    ...
    <p>
        ...
        In this ever changing and vast financial market data world, one could be a smaller sized player or a medium sized player or a bigger sized player. But all are here with a common goal - <br>
        <span style="display: list-item; display: relative; margin-left: 3em">Making
							one’s presence meaningful in this market.</span> <span style="display: list-item; display: relative; margin-left: 3em">Drawing
							the attention of quality customer towards one’s data offerings.</span> <span style="display: list-item; display: relative; margin-left: 3em">Compete
							with bigger sized competitor on equal-footing, Gain Market Share
							and add value for your stakeholders and shareholders.</span> <span style="display: list-item; display: relative; margin-left: 3em">Minimizing
							the customer acquisition time as less as possible.</span> <span style="display: list-item; display: relative; margin-left: 3em">Keeping
...
<div class="inner-left-wrap" id="SOLUTIONS_tavd">
    ...
    <p>
        ...
        There are multitudes of trading application vendors across the world. One could be a smaller sized player or a medium sized player or a bigger sized player. But all are here with a common goal - <br>
        <span style="display: list-item; display: relative; margin-left: 3em">Making
						one’s presence meaningful in this market.</span> <span style="display: list-item; display: relative; margin-left: 3em">Drawing
						the attention of quality customer towards one’s trading
						application offerings.</span> <span style="display: list-item; display: relative; margin-left: 3em">Compete
						with bigger sized competitor on equal-footing, Gain Market Share
						and add value for your stakeholders and shareholders.</span> <span style="display: list-item; display: relative; margin-left: 3em">Minimizing
						the customer acquisition time as less as possible.</span> <span style="display: list-item; display: relative; margin-left: 3em">Keeping
...
<div class="inner-left-wrap" id="SOLUTIONS_faavd">
    ...
    <p>
        ...
        Each new financial regulation is proving to be an opportunity as well as huge challenge for Financial Analytics (such as, Risk Analytics or Trade analytics) application vendors. One could be a smaller sized player or a medium sized player or a bigger sized player. But all are here with a common goal - <br> <span style="display: list-item; display: relative; margin-left: 3em">Making
					one’s presence meaningful in this market.</span> <span style="display: list-item; display: relative; margin-left: 3em">Drawing
					the attention of quality customer towards one’s Financial
					Analytics application offerings.</span> <span style="display: list-item; display: relative; margin-left: 3em">Compete
					with bigger sized competitor on equal-footing, Gain Market Share
					and add value for your stakeholders and shareholders.</span> <span style="display: list-item; display: relative; margin-left: 3em">Minimizing
					the customer acquisition time as less as possible.</span> <span style="display: list-item; display: relative; margin-left: 3em">Keeping
...
<div class="inner-left-wrap" id="SOLUTIONS_frrpd">
    ...
    <p>
        ...
        The presence of multitudes of research analysts creates a conundrum of some sorts- which analyst’s research report is better than others. One could be a smaller sized player or a medium sized player or a bigger sized player. But all are here with a common goal - <br> <span style="display: list-item; display: relative; margin-left: 3em">Making
				one’s presence meaningful in this market.</span> <span style="display: list-item; display: relative; margin-left: 3em">Drawing
				the attention of quality customer towards one’s research coverage.</span>
        <span style="display: list-item; display: relative; margin-left: 3em">Compete
				with bigger sized competitor on equal-footing, Gain Market Share
				and add value for your stakeholders and shareholders.</span> <span style="display: list-item; display: relative; margin-left: 3em">Minimizing
				the customer acquisition time as less as possible.</span> <span style="display: list-item; display: relative; margin-left: 3em">Keeping
    ...
    <p>Only End users can access your listing info. None of your competitors would be able to see your product offerings. One of the examples of End user requirement</p>
    <p style="background-color: lightgray">
        <b>MyPortfolio</b>, a fund management house, has launched its new emerging market centric fund few months back. They are looking for a research report providers who performs the Macro economic Analysis, Sector Analysis, Industry Analysis, Commodity Analysis, Exchange Rate Analysis, Interest Rate Analysis, Equity research, Debt Market research, Index research, Fund/ETF research for Indian markets, Indonesian markets, Philippines markets, Vietnam Markets. The vendor should distribute the report in PDF format through email. Subscription fee for this application should not exceed $1000 per month. Vendor should have 24x7 support coverage in APAC market hour. Vendor should be in this business since more than 3 years. Vendor’s company should be either LLP or private limited
    </p>
...
<div class="inner-left-wrap" id="About">
    ...
    <p>Our goal is to provide a common platform to small, medium and large size vendor to showcase their product offerings in a uniform and comprehensive way. This, in term, creates a win-win situation for both financial vendors as well as for End-Users. Financial vendors are given a level -playing field to compete with other vendors on equal-footing. Financial End users find a hassle-free way to choose a right vendor and perform due-diligence on the financial vendor for their product needs. FinVendor founders saw this gap in the financial industry and thus FinVendor idea took its shape.
    </p>
    <p>
    ...
    <div id="container">
        ...
        <form action="<%=request.getContextPath()%>/<%=RequestConstans.MAIL.MAIL_SEND%>" method="post" id="contact_us_form" style="width: 350px">
            <div class="form-group">
                <label>Name</label> <input type="text" name="contact_us_name" class="form-control" id="contact_us_name" placeholder="Name" size="30" /> <span id="contactNameError" style="display: none;">Please
	enter your Name.</span>
            </div>
            <div class="form-group">
                <label>Phone</label> <input type="text" name="contact_us_phone" class="form-control" id="contact_us_phone" placeholder="Phone" size="30" /> <span id="contactPhoneError" style="display: none;">Please
	enter a valid phone number</span>
            </div>
            <div class="form-group">
                <label>Email</label> <input type="text" name="contact_us_email" class="form-control" id="contact_us_email" placeholder="Email" size="30" /> <span id="contactEmailError" style="display: none;">Please
...
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/mail-functions.js"></script>	
						...
						<div class="col-xs-12 col-sm-4 col-md-3">
							<jsp:include page="inner_sidebar.jsp"></jsp:include>
						</div>
					</div>
    ...
    <script>
        ...
        $('li').filter(function() {
            return $.text([this]) === '${requestConstants.reqParamDescriptionMap[requestMapKey]}';
        }).addClass('li-ico'); 
        </c:when> 
        <c:otherwise>
            $('#${param.nav}').show();
