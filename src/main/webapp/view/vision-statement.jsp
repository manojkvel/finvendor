...
<html>
<head>
<title>Vision Statement - Finvendor</title>
	<meta charset="utf-8" />
...
<body>
	...
	<div class="container" id="vision_statement">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-8 col-md-9">
				<div class="default_template">
					<div class="content">
						<p>
							FinVendor endeavours assiduously to strengthen the investing community so that they can take a well-informed investment decision.
						</p>
					</div>
				</div>
			</div>
